...
contract Setup is ExtendedTest, IEvents {
	...
	function checkStrategyTotals(
		...
		assertApproxEqAbs(_strategy.totalDebt(), _totalDebt, 100, "!totalDebt");
		assertApproxEqAbs(_strategy.totalIdle(), _totalIdle, 100, "!totalIdle");
		assertApproxEqAbs(_totalAssets, _totalDebt + _totalIdle, 100, "!Added");
	}
