...
contract DeltaTest is Setup {
    ...
    // forge test -vv --fork-url https://rpc.ankr.com/polygon --match-contract ShutdownTest
    // forge test -vv --fork-url https://rpc.ankr.com/polygon
    ...
    function test_DeltaCredit_Withdrawal_StargateSide(uint256 amountLP) public {
        ...
        // +1 is for roundings
        vm.assume(
            amountLP > ((deltaCredit * ts) / tl) + 1 &&
                amountLP < 1_000_000 * 1e6
        );
